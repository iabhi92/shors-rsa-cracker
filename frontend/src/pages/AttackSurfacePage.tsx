...
import { Crosshair, KeyRound, MessageSquareWarning, Radio, ShieldAlert } from 'lucide-react'
import { Card, PageHeader, StatCard, Table } from '../components/ui'

type Category = 'Key recovery' | 'Message recovery' | 'Message manipulation' | 'Side-channel'
...
// Every row here is a real, live demo elsewhere on this site -- this page is a map of what's
// already built, not a wishlist. Kept deliberately separate from Security Dashboard (which is
// about this site's own infrastructure hygiene -- headers, dependency audit, OWASP mapping):
// this is about the cryptographic attack surface of RSA itself.
