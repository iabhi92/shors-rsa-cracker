 ...
 * animation sweeping across it once (a "here's your key" beat, not a static icon). Recolored to
 * this site's own gold/harbour palette -- this component had been left on its original generic
 * Tailwind amber/zinc hex values (#fbbf24, #e2793d, #52525b, #71717a) even after its sibling
 * VaultIllustration.tsx was corrected earlier, a real inconsistency caught on a full-codebase
 * palette audit rather than by anyone noticing it on screen. */
export default function KeyIllustration() {
  return (
    <svg viewBox="0 0 160 100" className="h-full w-full" role="img" aria-label="An illustrated key">
      ...
      />
      {/* bow center hole */}
      <circle cx="73" cy="50" r="14" fill="#0b1018" stroke="#e3b45e" strokeWidth="2" />
      <circle cx="73" cy="50" r="14" fill="none" stroke="#8c919b" strokeWidth="0.75" strokeDasharray="2 3" />

      {/* teeth notches on the shaft */}
      <path d="M 30 68 L 30 74 M 22 58 L 22 63" stroke="#8c919b" strokeWidth="2" strokeLinecap="round" />
