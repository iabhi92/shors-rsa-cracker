...
[![Tests](https://img.shields.io/badge/tests-386%20passing-brightgreen)](data/test_summary.json)
...
pre-computed answer. `pytest` runs the full test suite (386 tests). For the interactive
...
Core is built and tested (386 tests, `pytest`): RSA from scratch, a 4-method classical
